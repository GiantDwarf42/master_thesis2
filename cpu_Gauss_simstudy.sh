#!/bin/sh
#SBATCH --job-name Gauss_18.07_2000it_200rep            # this is a parameter to help you sort your job when listing it
...
#SBATCH --mem=5000                      #memory needed (default 3GB)
...
srun python Gaussian_univariate_case_simstudy.py $SLURM_ARRAY_TASK_ID              
# run your software
