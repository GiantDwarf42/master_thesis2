...
#SBATCH --cpus-per-task 25             # number of cpus for each task. One by default
#SBATCH --array=1-20
...
#SBATCH --time 600:00                  # maximum run time.
...
srun python Huesler_Reis_simstudy_server_test_duration.py $SLURM_ARRAY_TASK_ID              
# run your software
