#!/bin/sh
#SBATCH --job-name Gauss_19.07_rawdata_processing           # this is a parameter to help you sort your job when listing it
...
#SBATCH --mem=30G                      #memory needed (default 3GB)
...
srun python Gaussian_Data_Analysis_server.py
# run your software
