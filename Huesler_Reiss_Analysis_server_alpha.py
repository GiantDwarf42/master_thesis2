...
# %%
load_path = r"/home/users/k/kipfer2/Huesler_Reiss_processed_results_alpha/Data/Huesler_Reiss_Processed_data_alpha.pkl"
...
# %%
# %%
saving_path_result_data = f"/home/users/k/kipfer2/Huesler_Reiss_processed_results_alpha/processed_tables"

# %%

data_output = df_last_150_proper_aggregation_index_reset
data_output.to_pickle(f"{saving_path_result_data}/Huesler_Reiss_result_alpha.pkl")
data_output.to_csv(f"{saving_path_result_data}/Huesler_Reiss_result_gumbel_alpha.csv")
...
# %%
saving_path_convergence = r"/home/users/k/kipfer2/Huesler_Reiss_processed_results_alpha/convergence_charts"
...
# %%
saving_path_sample_size_effect = r"/home/users/k/kipfer2/Huesler_Reiss_processed_results_alpha/violin_charts"
