#!/bin/sh
#SBATCH --job-name Huesler_Reiss_rawdata_processing_test_duration           # this is a parameter to help you sort your job when listing it
...
#SBATCH --cpus-per-task 3             # number of cpus for each task. One by default


#SBATCH --partition shared-cpu 	# the partition to use. By default debug-cpu		
    				
				
#SBATCH --mem=100G                      #memory needed (default 3GB)
#SBATCH --time 200:00                  # maximum run time.
...
srun python Huesler_Reiss_rawdata_processing_modified.py
# run your software
